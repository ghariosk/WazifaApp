...
export default class CustomDurationPickerIOS extends React.PureComponent {
  static propTypes = {
  ...
  handleMinutesChange = minutes => {
    ...
    userIsInteractingWithPicker: false})
    this.props.onMinuteChange(minutes)
  }

   handleHoursChange = hours => {
    this.setState({hours,
    userIsInteractingWithPicker: false})
    this.props.onHourChange(hours)
  }
  ...
  render() {
  let pickerItemHours = this.state.durationHours.map((s,i) => {
    return <Picker.Item key={i} value={s} label={s}/>
   })

   let pickerItemMinutes = this.state.durationMinutes.map((s,i) => {
    return <Picker.Item key={i} value={s} label={s}/>
   })
    ...
    return (
      ...
      <View style={styles.pickers}>
        ...
        onValueChange={this.handleMinutesChange}
        >
        {pickerItemMinutes}
        </Picker>
        </View>
